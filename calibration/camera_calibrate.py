...
class StereoCalibration(object):
    ...
    def read_images(self, cal_path):
        ...
        print(len(self.imgpoints_l), len(self.imgpoints_r))
    ...
    def stereo_calibrate(self, dims):
        ...
        # flags |= cv2.CALIB_RAexTIONAL_MODEL
        ...
        np.savez(file, intrinsic_mtx_l=M1, dist_l=d1,  intrinsic_mtx_r=M2, dist_r=d2, rvecsl=self.r1, rvecsr=self.r2, R=R, T=T, E=E, F=F)
